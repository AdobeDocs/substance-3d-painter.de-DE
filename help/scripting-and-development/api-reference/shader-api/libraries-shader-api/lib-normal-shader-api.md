...
**Öffentliche Funktionen:** *normalBlend* *normalBlendOriented* *normalFade* *normalUnpack* *normalFromBaseNormal* *normalFromNormal* *normalFromHeight* *getTSNormal* *SuteComputeWute BaseNormal* *computeWSNormal*
...
Empirisch bestimmt von unseren Künstlern...
...
Gibt eine Normale zurück, die um einen Dämpfungsfaktor abgeflacht wird.
