...
helpx_learn_topic: ""
helpx_tags: ""
title: Alle benutzerdefinierten Parameter - Shader-API
...
Gruppieren Sie Ihre Parameter, indem Sie einen *group*-Wert hinzufügen.

Verbergen Sie einen Parameter in der Benutzeroberfläche, indem Sie einen *visible*-Wert auf *false* festlegen.

Fügen Sie dem Parameter eine QuickInfo hinzu, indem Sie einen *description*-Wert festlegen.
