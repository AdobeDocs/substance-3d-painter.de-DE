---
helpx_url: "https://helpx.adobe.com/de/substance-3d-painter/scripting-and-development/api-reference/shader-api/parameters-shader-api/layering-bind-materials-shader-api.html"
breadcrumb-title: ''
...
helpx_learn_topic: ""
helpx_tags: ""
title: Schichtung von Bindematerialien - Shader-API
...
# Schichtung von Bindematerialien - Shader-API

## Materialschichtung: Materialien als Shader-Parameter binden

Ein Material wird durch einen eindeutigen Bezeichner &quot;id&quot; definiert. Zusätzliche Parameter:

* &#39;default&#39;: der Standard-Materialressourcenname, der verwendet werden soll.
* &#39;Größe&#39;: die Texturgröße der Materialkarten.
* Gruppe: der UI-Gruppe des Materialauswahl-Widgets.
...
Um einen Kanal von einem Material an einen Sampler zu binden, definieren Sie einen automatischen Parameter mit der ID des Materials, gefolgt vom Kanal-Tag (siehe die verfügbaren Kanäle in [all-engine-params.glsl](all-engine-params-shader-api.md)):
