...
Nicht alle Füllmethoden sind für alle Anwendungsfälle geeignet. Die **Normale Karte** Mischmodi sind beispielsweise nur für den **Normalen Kanal** in einem Textursatz nützlich.

## Reihenfolge der Füllmethoden

Um zu verstehen, wie und wann ein Mischmodus angewendet wird, ist es wichtig, die Reihenfolge zu verstehen, in der Vorgänge im **Ebenenstapel** ausgeführt werden:
...
Der Mischmodus kann für **jeden Kanal** in einer Ebene geändert werden. Um zwischen den Kanälen zu wechseln, verwenden Sie das Dropdown-Menü links oben im Ebenenstapelfenster.
...
| Passthrough | Reduziert die Ebene &quot;Unten&quot; auf die Ebene &quot;Oben&quot;. Meist nützlich in den folgenden Fällen:<ul data-preserve-html="true"> <li data-preserve-html="true">So wenden Sie einen Effekt auf alle Ebenen unter der Ebene &quot;Top&quot; an</li> <li data-preserve-html="true">So verwischen oder klonen Sie die Ebenen unter der oberen Ebene</li> </ul> <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r2-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/blending-passthrough.jpg"/></div> **Hinweis:** **Effekte** können **direkt in den Ebenenstapel gezogen und abgelegt werden**. Dadurch wird eine Ebene mit dem Mischmodus &quot;PassThrough&quot; für alle Kanäle erstellt. |
| Disable | Verwirft die Überblendung der Ebene und zeigt nur die vorherigen Ebenen an. Er kann verwendet werden, um die Berechnung eines Kanals zu optimieren, indem er in der Ebene &quot;Top&quot; ignoriert wird. <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r3-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/blending-disable.jpg"/></div> |
...
| Umgekehrte Division | Identisch mit der Füllmethode &quot;Unterteilen&quot;, aber die Ebenen &quot;Oben&quot; und &quot;Unten&quot; werden bei der Füllmethode ausgetauscht. <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r8-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/blending-inverse-divide.jpg"/></div> |
...
|  |  |
| Normale Kartenkombination | Whiteout-Füllmethode. Behalten Sie die Details bei, während Sie sicherstellen, dass flache Normalen weiterhin ordnungsgemäß funktionieren. Weitere Informationen finden Sie unter [Normal Map Painting](../../painting/advanced-channel-painting/normal-map-painting.md). <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r36-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/blending-normal-combine.jpg"/></div> |
| Normale Kartendetails | Detailorientierter Mischvorgang (neu ausgerichtete Normalzuordnung), präziser als &quot;Normalzuordnung kombinieren&quot;. Erhalten Sie flache Normalmaps und die Intensität der beiden Quellen. Um sicherzustellen, dass das Ergebnis die Normale der obersten Ebene neu ausgerichtet wird, sodass sie der Oberfläche der untersten Ebene folgt. Weitere Informationen finden Sie unter [Normal Map Painting](../../painting/advanced-channel-painting/normal-map-painting.md). <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r37-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/blending-normal-detail.jpg"/></div> |
| Umgekehrte Details der Normalmap | Dasselbe Verhalten wie beim Füllvorgang für &quot;Normale Kartendetails&quot;. Es ist jedoch die Ebene &quot;Unten&quot;, die transformiert wird, damit sie zur Oberfläche der Ebene &quot;Oben&quot; passt. Weitere Informationen finden Sie unter [Normal Map Painting](../../painting/advanced-channel-painting/normal-map-painting.md). <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r38-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/blending-normal-inverse-detail.jpg"/></div> |
