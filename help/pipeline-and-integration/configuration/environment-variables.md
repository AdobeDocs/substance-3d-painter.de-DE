...
| **OCIO** | Pfad zu einer **config.ocio**-Datei, die verwendet wird, um die Einstellungen für [Farbmanagement](../../features/color-management/color-management.md) mit OpenColorIO zu steuern.  **Hinweis:** Diese Umgebungsvariable hat Vorrang vor der Variablen **PAINTER\_ACE\_CONFIG**. | <ol data-preserve-html="true"><li data-preserve-html="true">4</li></ol> |
...
| **ALG\_PAINTER\_DEBUG\_FPS** | Zeigt im Viewport einen Zähler an, der angibt, wie viele Rahmen pro Sekunde vom Viewport gerendert werden. | <ol data-preserve-html="true"><li data-preserve-html="true">1</li></ol> |
