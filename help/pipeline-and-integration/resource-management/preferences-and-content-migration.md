---
helpx_url: "https://helpx.adobe.com/de/substance-3d-painter/pipeline-and-integration/resource-management/preferences-and-content-migration.html"
breadcrumb-title: ''
...
Auf dieser Seite wird beschrieben, wie Daten aus den Voreinstellungen und aus Shelf-/Assets migriert werden, um sie in den neuen Versionen zu verwenden.

Nach der Veröffentlichung von Version 7.2 haben sich die Einstellungen und der Speicherort des Shelf geändert, um sie in den verschiedenen Versionen der Anwendung (Substance 3D Standalone, Steam und Creative Cloud Desktop) gemeinsam zu nutzen. Diese Änderung bedeutet, dass vorherige Voreinstellungen und benutzerdefinierte Ressourcen **jetzt standardmäßig ignoriert** werden (**, aber nicht verloren**). Da **Shelf** in **Assets** umbenannt wurde, umfasst die Migration einige der unten beschriebenen Schritte.

## Migration von Shelf- und Asset-Ressourcen
...
Der Pfad zu den Shelf- oder Assets-Elementen befindet sich an folgenden Speicherorten:
...
### So migrieren Sie den Inhalt des Shelf

Bei den alten Shelf-Inhalten handelt es sich nur um Dateien auf der Festplatte. Bei der Migration geht es also nur darum, diese Dateien an der richtigen Stelle zu platzieren.

1. Schließen der Anwendung
1. Navigieren Sie zum alten Ordner &quot;Shelf&quot;
1. Kopieren oder Ausschneiden der Unterordner (Alphas, Prozeduren, Materialien usw.)
...
>[!NOTE]
>
> Achten Sie darauf, die Unterordner und nicht nur den übergeordneten Ordner der Ressourcen zu kopieren. Der übergeordnete Ordner wurde von &quot;**Shelf**&quot; in &quot;**Elemente**&quot; umbenannt. Wenn Sie also nur den übergeordneten Ordner kopieren, werden die Ressourcen für die Anwendung nicht sichtbar.

### So migrieren Sie die Shelf-Vorgaben

Shelf-Vorgaben werden in einer Konfigurationsdatei gespeichert. So migrieren Sie diese Vorgaben:

1. Schließen der Anwendung
1. Navigieren Sie zum alten Ordner &quot;Shelf&quot;
1. Datei &quot;Shelf.ini&quot; kopieren oder ausschneiden
1. Navigieren Sie zum neuen Assets-Ordner
