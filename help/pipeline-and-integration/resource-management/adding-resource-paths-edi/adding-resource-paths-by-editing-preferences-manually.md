...
>[!NOTE]
>
> Netzwerkpfade werden nicht unterstützt. Stellen Sie sicher, dass Sie einen eingehängten Pfad verwenden, um Probleme zu vermeiden. Siehe : [Dateien werden aus einem Netzwerk geladen](../../../technical-support/workflow-issues/project-issues/loading-files-from-a-network.md).
