...
* Verwenden einer vorhandenen Substance-Ressource zum Erstellen einer neuen Pinsel-/Werkzeugvorgabe
...
Suchen Sie im Shelf nach kompatiblen Ressourcen, die Ihren Anforderungen entsprechen, und sehen Sie sich dann unsere Seite zu [Vorgaben](../presets/presets.md) an.

## Erstellen benutzerdefinierter Substance-Dateien für Dynamische Pinselstriche

Nachfolgend finden Sie eine Liste der unterstützten Parameter für Dynamische Pinselstriche in Substance-Graphen.

| Variablenkennung | Beschreibung |
| --- | --- |
| <b>Zufallsparameter</b> | Wenn eine Substance-Datei mit zufälligem Seed gekocht wird, wird sie mit der Funktion &quot;Dynamischer Strich&quot; steuerbar sein. |
| <b>stampIndex</b> | <b>Integer1</b> Wird beim Malen des Pinselstrichs von Substance 3D Painter zugeführt. Die Minimal- und Maximalwerte haben keine Auswirkungen, sie werden von Substance 3D Painter ignoriert. |
| <b>stampCycleCount</b> | <b>Integer1</b> Painter liest den Parameterstandardwert, den Minimalwert und den Maximalwert, um den Parameter &quot;Stempelzyklusanzahl&quot; anzuzeigen. Dieser Parameter steuert, wie viele eindeutige Substance-Varianten erstellt werden. |
| <b>$time</b> | <b>Float1</b> Wird von Substance 3D Painter beim Malen des Pinselstrichs auf der Grundlage der verstrichenen Malzeit (pro Strich) zugeführt. Diese Eigenschaft kann viele Substance-Varianten generieren und sich daher auf die Leistung auswirken. |
...
| <b>stampStrokePosition</b> | <b>integer1</b> Wird verwendet, um den Anfang/Anfang einer Kontur anzugeben. Der Endwert ist nur auf dem Pfadstrich verfügbar, nicht beim manuellen Malen. Mögliche Werte:<ul data-preserve-html="true"> <li data-preserve-html="true">0 = Mitte</li> <li data-preserve-html="true">1 = Start</li> <li data-preserve-html="true">2 = Ende</li> </ul>Kann mit dem isstrokepositionactive Benutzertag deaktiviert werden. |
