...
breadcrumb-title: ''
description: Mit dem Radiergummi-Werkzeug von Substance 3D Painter lassen sich Farben und Strukturen präzise aus 3D-Modellen entfernen.
...
Der Radiergummi ist ein Malwerkzeug, mit dem zuvor von anderen Werkzeugen gemalte Objekte gelöscht oder ausgeblendet werden. Dieses Werkzeug wirkt sich jeweils nur auf eine Ebene aus.

Mit dem Radiergummi-Werkzeug lassen sich gängige Parameter und Verhaltensweisen des Radiergummis festlegen. Weitere Informationen zum Pinsel sowie zu den Alpha- und Schablonensteuerelementen finden Sie auf der [Seite des Malwerkzeugs](paint-brush.md).
...
> * Ein Substance-Filter kann die Malinformationen abrufen, wenn er die Alpha-Informationen ignoriert.
> 
...
>[!NOTE]
>
> Im Gegensatz zum Malwerkzeug kann mit dem Radiergummi nur festgelegt werden, welche Kanäle betroffen sind. Es ist nicht möglich, eine Ressource aus dem Shelf zu laden, um jeden Kanal zu beeinflussen.
