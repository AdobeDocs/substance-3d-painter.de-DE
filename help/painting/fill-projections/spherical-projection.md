...
breadcrumb-title: ''
description: In Substance 3D Painter kannst du mit sphärische Projektion Texturen aus einer Kugel projizieren, um Texturen um Objekte zu legen.
...
| **Drehung** | Steuern Sie den Winkel der Textur, die auf die Projektion angewendet wird. |
| **Offset** | Steuern Sie den Ursprung der projizierten Textur. Der Standardwert bedeutet, dass sich die Textur in der Mitte der Projektion befindet. |
