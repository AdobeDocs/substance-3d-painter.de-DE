---
helpx_url: "https://helpx.adobe.com/de/substance-3d-painter/painting/vector-graphic-svg.html"
breadcrumb-title: ''
...
Vektorgrafikdateien (sowohl <b>.svg</b> als auch Illustrator <b>.ai</b>) können wie normale Bilder in Painter importiert werden. Mit einigen wenigen verfügbaren Einstellungen kannst du das Aussehen der Grafik anpassen und sie an die restlichen Strukturen anpassen.
...
|  | Quadratisches Seitenverhältnis | Wenn der Zuschneidebereich durch <b>Elementgrenzen</b> definiert ist, stellt diese Einstellung sicher, dass das Originalverhältnis beibehalten wird, sodass beim Rendern der SVG als quadratisches Bild keine falsche Dehnung auftritt.   Diese Einstellung kann dazu führen, dass einige Elemente unerwartet sichtbar werden. Um dieses Problem zu vermeiden, deaktivieren Sie diese Einstellung und passen Sie die UV-Einstellungen stattdessen manuell an, wenn Sie sich in einer Füllebene/einem Fülleffekt befinden. |
...
Wenn Sie den Suchbereich einer Vektorgrafik bearbeiten (siehe Einstellung oben), wird ein Fenster mit einer Liste von Elementen angezeigt, in denen Sie auswählen können, was in das endgültige gerenderte Bild ein- oder ausgeschlossen werden soll.
