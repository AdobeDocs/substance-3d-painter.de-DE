...
* `[Shelf]` `[Substance]` Benutzerdaten werden für die Generierung von Miniaturansichten der Ablage nicht berücksichtigt.
...
* Die Kanalzuordnung funktioniert in einigen Fällen nicht für die Vorschau des Projektionswerkzeugs.
