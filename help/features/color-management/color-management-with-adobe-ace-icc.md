---
helpx_url: "https://helpx.adobe.com/de/substance-3d-painter/features/color-management/color-management-with-adobe-ace-icc.html"
breadcrumb-title: ''
description: Erfahren Sie, wie Sie das Adobe ACE- und ICC-Farbmanagement in Substance 3D Painter für konsistente Farbarbeitsabläufe verwenden.
...
| --- | --- | --- |
| **Konfiguration** | **Farbmanagement** | Legen Sie fest, mit welcher Engine Farben verwaltet werden.Mögliche Werte:<ul data-preserve-html="true"> <li data-preserve-html="true"><strong>Legacy</strong> (Standard): Verwenden Sie die vordefinierte sRGB/Linear sRGB Gamma-Farbkorrektur.</li> <li data-preserve-html="true"><strong>OpenColorIO</strong>: OCIO-Integration.</li> <li data-preserve-html="true"><strong>Adobe ACE</strong>: Adobe Color Engine, um ICC-Profile zu unterstützen.</li> </ul> |
...
|  |  |  |
| **Farbeinstellungen** | **Arbeitsfarbraum** | Der Farbraum, der vom Modul zum Arbeiten innerhalb der Anwendung verwendet wird. Dies ist der Farbraum, aus dem Texturen konvertiert werden können in (Import) oder aus (Export). Mögliche Werte sind:<ul data-preserve-html="true"> <li data-preserve-html="true"><strong>Linear sRGB IEC61966-2.1</strong> (Standard)</li> <li data-preserve-html="true"><strong>ACEScg ACES-Arbeitsbereich AMPAS S-2014-004</strong></li> <li data-preserve-html="true"><strong>Linearer Adobe RGB (1998)</strong></li> </ul> |
...
|  |  |  |
| **Substance von Material** | **Standard für Materialfarbraum** | Legen Sie fest, welcher Farbraum für das Substance von mit Farbmanagement verwalteten Ein-/Ausgaben verwendet werden soll. |
|  |  |  |
...
|  | **Gleitkommabilder** | Standardmäßig zu verwendender Farbraum beim Exportieren von HDR-/EXR-Bilddateien. |

## Verwenden einer Vorgabedatei

![](../../assets/cm-ace-env-var.png)

Es ist möglich, eine voreingestellte Datei (im JSON-Format) zu verwenden, um die ACE-Einstellungen beim Erstellen neuer Projekte zu steuern.

### Umgebungsvariable

Die Umgebungsvariable **PAINTER\_ACE\_CONFIG** kann verwendet werden, um den Pfad einer Voreinstellungsdatei anzugeben. Wenn vorhanden, verwendet die Anwendung immer eine Vorgabedatei, um die Farbmanagementeinstellungen zu steuern. Die Einstellungen werden in der Benutzeroberfläche deaktiviert.
