...
| --- | --- |
| **Umkehren** | Generatorausgabe umkehren. |
| **Saldo** | Verschiebe den Mittelpunkt des Effekts wie bei einem Helligkeitsregler in Richtung Schwarz oder Weiß. |
| **Kontrast** | Passen Sie den Kontrast/Abfall des Effekts an. |
| **Smoothness** | Passen Sie die Rundheit des Effekts an. Dies ist am besten sichtbar, wenn ein niedriger **Smoothness**-Wert verwendet wird. |
| **Entfernung** | Passen Sie an, wie weit der Effekt von den UV-Rändern entfernt ist. |
