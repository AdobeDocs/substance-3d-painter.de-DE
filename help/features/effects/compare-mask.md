...
breadcrumb-title: ''
description: Erfahren Sie, wie Sie den Maskeneffekt in Substance 3D Painter verwenden, um Vergleichsmasken auf der Grundlage von Maskenvergleichsvorgängen zu erstellen.
...
| --- | --- |
| **Kanal** | Der Kanal, der zwischen Quelle und Ziel verglichen werden soll, aus dem eine Maske erstellt werden soll. Diese Liste basiert auf dem Kanal, der in den [Kanaleinstellungen](../../interface/texture-set/texture-set-settings.md) des Textursatzes verfügbar ist. |
...
| **Histogramm für Quellkanal** | Bereitstellen einer Histogrammansicht der Quelle und des Ziels. Nützlich, um zu wissen, ob sie sich ein bisschen oder überhaupt nicht überlappen (wenn sie sich nicht überlappen, ist die Maske leer).Weitere Informationen über die Funktionsweise des Histogramms finden Sie unter : [Stufen](https://experienceleague.adobe.com/de/docs/substance-3d-designer/using/substance-graphs/nodes-reference-for-substance-graphs/atomic-nodes/levels). |

>[!NOTE]
>
> Es ist möglich, mit der rechten Maustaste auf eine Ebene zu klicken und den Tastaturbefehl &quot;**Maske mit Effektkombination hinzufügen**&quot; auszuwählen, um diesen neuen Height schnell auf einer Ebene hinzuzufügen. Dieser Tastaturbefehl wechselt auch den Height-Kanal &quot;**Füllmethode**&quot; zu &quot;**Normal**&quot; anstelle des Standardkanals &quot;**Linear abwedeln (Hinzufügen)**&quot;.\
